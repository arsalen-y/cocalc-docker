...
docker tag cocalc-personal:latest build.yields.io/chiron-enterprise/cocalc-v2-personal:1.0
docker push build.yields.io/chiron-enterprise/cocalc-v2-personal:1.0